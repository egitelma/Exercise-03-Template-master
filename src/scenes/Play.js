class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.cameras.main.startFollow(this.hero, false, 0.5, 0.5); //roundPixels = true creates jitter. Not good for pixel art

        this.physics.world.setBounds(0, 0, this.map.width, this.map.height); //checkLeft = false lets you walk off the left side of the map
